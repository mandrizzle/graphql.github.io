...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {var id = 100;
	...
	function friends(user, first) {
	  var allFriends = Object.keys(data).map(function (id) {
	    return data[id];
	  }).filter(function (v) {
	    return v !== user;
	  });
	...
	var _coreMiniGraphiQL = __webpack_require__(77);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _execution = __webpack_require__(65);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _execute = __webpack_require__(60);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _kinds = __webpack_require__(12);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _GraphQLError = __webpack_require__(6);
	...
	var _syntaxError = __webpack_require__(13);
	...
	var _locatedError = __webpack_require__(14);
	...
	var _formatError = __webpack_require__(15);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _printer = __webpack_require__(10);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _specifiedRules = __webpack_require__(31);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _definition = __webpack_require__(19);

	var _directives = __webpack_require__(22);

	var _introspection = __webpack_require__(24);
	...
	var _typeComparators = __webpack_require__(28);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _assertValidName = __webpack_require__(21);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _astFromValue = __webpack_require__(25);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _iterall = __webpack_require__(26);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _typeFromAST = __webpack_require__(30);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _UniqueOperationNames = __webpack_require__(32);

	var _LoneAnonymousOperation = __webpack_require__(33);

	var _KnownTypeNames = __webpack_require__(34);

	var _FragmentsOnCompositeTypes = __webpack_require__(37);

	var _VariablesAreInputTypes = __webpack_require__(38);

	var _ScalarLeafs = __webpack_require__(39);

	var _FieldsOnCorrectType = __webpack_require__(40);

	var _UniqueFragmentNames = __webpack_require__(41);

	var _KnownFragmentNames = __webpack_require__(42);

	var _NoUnusedFragments = __webpack_require__(43);

	var _PossibleFragmentSpreads = __webpack_require__(44);

	var _NoFragmentCycles = __webpack_require__(45);

	var _UniqueVariableNames = __webpack_require__(46);

	var _NoUndefinedVariables = __webpack_require__(47);

	var _NoUnusedVariables = __webpack_require__(48);

	var _KnownDirectives = __webpack_require__(49);

	var _KnownArgumentNames = __webpack_require__(50);

	var _UniqueArgumentNames = __webpack_require__(51);

	var _ArgumentsOfCorrectType = __webpack_require__(52);

	var _ProvidedNonNullArguments = __webpack_require__(55);

	var _DefaultValuesOfCorrectType = __webpack_require__(56);

	var _VariablesInAllowedPosition = __webpack_require__(57);

	var _OverlappingFieldsCanBeMerged = __webpack_require__(58);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _suggestionList = __webpack_require__(35);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _isValidLiteralValue = __webpack_require__(53);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _introspectionQuery = __webpack_require__(68);
	...
	var _getOperationAST = __webpack_require__(69);
	...
	var _buildClientSchema = __webpack_require__(70);
	...
	var _buildASTSchema = __webpack_require__(72);
	...
	var _extendSchema = __webpack_require__(73);
	...
	var _schemaPrinter = __webpack_require__(74);
	...
	var _separateOperations = __webpack_require__(76);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _get = __webpack_require__(78)['default'];

	var _inherits = __webpack_require__(94)['default'];

	var _createClass = __webpack_require__(103)['default'];

	var _classCallCheck = __webpack_require__(106)['default'];

	var _Object$keys = __webpack_require__(107)['default'];

	var _Object$create = __webpack_require__(95)['default'];

	var _interopRequireDefault = __webpack_require__(111)['default'];

	var _react = __webpack_require__(112);

	var _react2 = _interopRequireDefault(_react);

	var _marked = __webpack_require__(113);
	...
	module.exports = (function (_React$Component) {
	  ...
	  function MiniGraphiQL(props) {
	    ...
	    var query = props.query.replace(/^\s+/, '');
	  ...
	  _createClass(MiniGraphiQL, [{
	    ...
	    value: function render() {
	      var editor = _react2['default'].createElement(QueryEditor, {
	        key: 'query-editor',
	      ...
	      return _react2['default'].createElement(
	        ...
	        _Object$keys(this.state.variableToType).length > 0 ? _react2['default'].createElement(
	          'div',
	          { className: 'hasVariables' },
	          editor,
	          _react2['default'].createElement(VariableEditor, {
	    ...
	    key: '_runQueryFromEditor',
	    value: function _runQueryFromEditor() {
	      this.setState({
	    ...
	    key: '_runQuery',
	    value: function _runQuery() {
	      var _this = this;

	      this._editorQueryID++;
	      var queryID = this._editorQueryID;

	      (0, _graphql.graphql)(this.props.schema, this.state.query, this.props.rootValue, null, // context
	      this.state.variables && JSON.parse(this.state.variables)).then(function (result) {
	        if (result.errors) {
	    ...
	    key: '_handleEditQuery',
	    value: function _handleEditQuery(value) {
	      this.setState({ query: value });
	    }
	  }, {
	    key: '_handleEditVariables',
	    value: function _handleEditVariables(value) {
	...
	var QueryEditor = (function (_React$Component2) {
	  ...
	  _createClass(QueryEditor, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      var CodeMirror = __webpack_require__(114);
	    ...
	    value: function _onHasCompletion(cm, data) {
	      _onHasCompletion2(cm, data, this.props.onHintInformationRender);
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      return _react2['default'].createElement('div', { className: 'query-editor', ref: function (e) {
	          return _this3.domNode = e;
	        } });
	    }
	  }]);
	...
	var ResultViewer = (function (_React$Component3) {
	  ...
	  _createClass(ResultViewer, [{
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement('div', { className: 'result-window', ref: function (e) {
	          return _this4.domNode = e;
	        } });
	    }
	  }]);
	...
	var VariableEditor = (function (_React$Component4) {
	  _inherits(VariableEditor, _React$Component4);

	  function VariableEditor(props) {
	    _classCallCheck(this, VariableEditor);

	    _get(Object.getPrototypeOf(VariableEditor.prototype), 'constructor', this).call(this);
	  ...
	  _createClass(VariableEditor, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      this.editor = CodeMirror(this.domNode, {
	        ...
	        extraKeys: {
	          'Cmd-Space': function CmdSpace() {
	            return _this5.editor.showHint({ completeSingle: false });
	          },
	          'Ctrl-Space': function CtrlSpace() {
	            return _this5.editor.showHint({ completeSingle: false });
	          },
	          ...
	          'Cmd-Enter': function CmdEnter() {
	            if (_this5.props.onRunQuery) {
	              _this5.props.onRunQuery();
	            }
	          },
	          'Ctrl-Enter': function CtrlEnter() {
	            if (_this5.props.onRunQuery) {
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement('div', { className: 'variable-editor', ref: function (e) {
	          return _this6.domNode = e;
	        } });
	    }
	  }, {
	    key: '_didLint',
	    ...
	    key: 'onKeyUp',
	    value: function onKeyUp(cm, event) {
	      var code = event.keyCode;
	      if (code >= 65 && code <= 90 || // letters
	      !event.shiftKey && code >= 48 && code <= 57 || // numbers
	      event.shiftKey && code === 189 || // underscore
	    ...
	    key: 'onHasCompletion',
	    value: function onHasCompletion(cm, data) {
	      _onHasCompletion2(cm, data, this.props.onHintInformationRender);
	    }
	  }]);
	...
	function _onHasCompletion2(cm, data, onHintInformationRender) {
	  var CodeMirror = __webpack_require__(114);
	  var wrapper;
	  var information;
	...
	function getVariableToType(schema, documentStr) {
	  ...
	  try {
	    var _ret = (function () {
	      var documentAST = (0, _graphql.parse)(documentStr);
	      var variableToType = _Object$create(null);
	      documentAST.definitions.forEach(function (definition) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Object$getOwnPropertyDescriptor = __webpack_require__(79)["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Object$setPrototypeOf = __webpack_require__(97)["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(90).Object.setPrototypeOf;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getDesc  = __webpack_require__(81).getDesc
	...
	module.exports = {
	  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
	    function(test, buggy, set){
	      try {
	        set = __webpack_require__(91)(Function.call, getDesc(Object.prototype, '__proto__').set, 2);
	        set(test, []);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Object$defineProperty = __webpack_require__(104)["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(mod) {
	  if (true) // CommonJS
	    mod(__webpack_require__(114), __webpack_require__(121), __webpack_require__(117));
	  else if (typeof define == "function" && define.amd) // AMD
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _codemirror = __webpack_require__(114);

	var _codemirror2 = _interopRequireDefault(_codemirror);

	var _utilsGetHintsAtPosition = __webpack_require__(123);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _graphqlTypeIntrospection = __webpack_require__(24);

	var _forEachState = __webpack_require__(124);

	var _forEachState2 = _interopRequireDefault(_forEachState);

	var _hintList = __webpack_require__(125);

	var _hintList2 = _interopRequireDefault(_hintList);

	var _objectValues = __webpack_require__(126);

	var _objectValues2 = _interopRequireDefault(_objectValues);

	var _runParser = __webpack_require__(127);

	var _runParser2 = _interopRequireDefault(_runParser);

	var _Rules = __webpack_require__(130);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CharacterStream = __webpack_require__(128);

	var _CharacterStream2 = _interopRequireDefault(_CharacterStream);

	var _onlineParser = __webpack_require__(129);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsRuleHelpers = __webpack_require__(131);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsOnlineParser = __webpack_require__(129);

	var _utilsOnlineParser2 = _interopRequireDefault(_utilsOnlineParser);

	var _utilsRules = __webpack_require__(130);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsForEachState = __webpack_require__(124);

	var _utilsForEachState2 = _interopRequireDefault(_utilsForEachState);

	var _utilsHintList = __webpack_require__(125);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsJsonParse = __webpack_require__(137);
